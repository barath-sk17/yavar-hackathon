...
var todos = {
  create: function create(_ref, res, next) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var body, decoded, title, userId, todo;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            body = _ref.body, decoded = _ref.decoded;
            _context.prev = 1;
            title = body.title;
  ...
  fetchOne: function fetchOne(_ref3, res, next) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var params, decoded, myTodo;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            params = _ref3.params, decoded = _ref3.decoded;
            _context3.prev = 1;
            _context3.next = 4;
            return Todo.findOne({
              where: {
  ...
  update: function update(_ref4, res, next) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var body, decoded, params, todo, updatedTodo;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            body = _ref4.body, decoded = _ref4.decoded, params = _ref4.params;
            _context4.prev = 1;
            _context4.next = 4;
            return Todo.findOne({
              where: {
  ...
  "delete": function _delete(_ref5, res, next) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      var params, decoded, todo;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            params = _ref5.params, decoded = _ref5.decoded;
            _context5.prev = 1;
            _context5.next = 4;
            return Todo.findOne({
              where: {
...
var _default = exports["default"] = todos;